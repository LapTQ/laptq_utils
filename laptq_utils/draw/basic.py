...
def cv2_putText(
    ...
    x1, y1 = org
    b, g, r = color
    cv2.putText(img, text, (x1 + 2, y1 + 2), fontFace, fontScale, (0, 0, 0), thickness, lineType)
    cv2.putText(img, text, (x1 + 1, y1 + 1), fontFace, fontScale, (b//2, g//2, r//2), thickness, lineType)
    cv2.putText(img, text, (x1 + 1, y1), fontFace, fontScale, (b//2, g//2, r//2), thickness, lineType)
    cv2.putText(img, text, (x1, y1 + 1), fontFace, fontScale, (b//2, g//2, r//2), thickness, lineType)
...
def cv2_rectangle(
    ...
    x2, y2 = pt2
    b, g, r = color
    cv2.rectangle(img, (x1 + 2, y1 + 2), (x2 + 2, y2 + 2), (0, 0, 0), thickness, lineType)
