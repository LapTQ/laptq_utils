...
POSTFIX__DIR__LABEL__INPUT="--PRED--DATA--None--MODEL--yolov8x-pose--TRAIN--exp--PREDICT--imgsz-640--conf-0.4--iou-0.45--keypoint-normalized--JSON"

PATH__DIR__LABEL__OUTPUT=/home/laptq/laptq-fs26-shoplifting-detection/outputs/helper--extract--ultralytics--imgdir
POSTFIX__DIR__LABEL__OUTPUT="--PRED--DATA--None--MODEL--yolov8x-pose--TRAIN--exp--PREDICT--imgsz-640--conf-0.4--iou-0.45--keypoint-normalized--filterby-roi--JSON"
...
for subpath__dir in "${!MAP__SUBPATH_DIR__TO__[@]}"; do
    ...
    python3 submodules/laptq_utils/main.py \
        ...
        --roi__polygonn "[0.125, 0, 0.125, 1, 0.875, 1, 0.875, 0]" \
        --thresh__miniou 0.9 \
