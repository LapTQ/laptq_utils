...
for subpath_dir in "${!MAP__SUBPATH_DIR__TO__[@]}"; do
    ...
    path__dir__img__input="${PATH__DIR__IMAGE__SOURCE}/${PREFIX__DIR}${subpath_dir__unslashed}/images${POSTFIX__DIR__IMG__SOURCE}"
    path__dir__img__output="${PATH__DIR__DATASETS__OUTPUT}/${subpath_dir}/images${POSTFIX__DIR__VERSION__TARGET}"
    path__dir__lbl__input="${PATH__DIR__LABEL__SOURCE}/${PREFIX__DIR}${subpath_dir__unslashed}/labels${POSTFIX__DIR__LABEL__SOURCE}"
