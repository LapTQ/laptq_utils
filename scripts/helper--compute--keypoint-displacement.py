...
if __name__ == "__main__":
    ...
    for subpathf, params in {
        ...
        kwargs = {
            "input_dir": "/home/laptq/laptq-fs26-shoplifting-detection/outputs/filter_action_by_keypoint_distance/ProtoGCN/prj54/v3_v6_v7_ensemble--filter-punch-distance-0.25/{}/labels".format(
                subpathf
            ),
            "output_dir": "/home/laptq/laptq-fs26-shoplifting-detection/outputs/helper--compute--keypoint-displacement/ProtoGCN/prj54/v3_v6_v7_ensemble--filter-punch-distance-0.25/{}/labels".format(
                subpathf
            ),
