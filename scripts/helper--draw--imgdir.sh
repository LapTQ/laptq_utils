PATH__DIR__IMAGE=/home/laptq/laptq-prj-44/outputs/to_annotation
POSTFIX__DIR__IMAGE=""
# POSTFIX__DIR__IMAGE="--erase-ignored"


PATH__DIR__LABEL=/home/laptq/laptq-prj-44/outputs/undo-split--dataset
POSTFIX__DIR__LABEL="--JSON"

NUM__MAX__IMG__TO__VISUALIZE=20
IS_OK__LBL_NOT_FOUND=False
PATH__DIR__OUTPUT=/home/laptq/laptq-prj-44/outputs/undo-split--dataset
