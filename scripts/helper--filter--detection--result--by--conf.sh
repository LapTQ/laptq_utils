...
PATH__DIR__LABEL__INPUT=/mnt/hdd10tb/Users/laptq/laptq-prj-46/outputs/20241208--model-prediction--json/${ID__MODEL}
...
PATH__DIR__LABEL__OUTPUT=/mnt/hdd10tb/Users/laptq/laptq-prj-46/outputs/20241208--model-prediction--json--filterby-conf/${ID__MODEL}
# POSTFIX__DIR__LABEL__INPUT=--20241128--phase-2--annotated-ver2--pot-man-drain--checked--only-pot
POSTFIX__DIR__LABEL__INPUT=--20241128--phase-2--annotated-ver2--pot-man-drain--checked--crop-top50-side20-botom0--rescaled-10
...
for subpath__dir in "${!MAP__SUBPATH_DIR__TO__[@]}"; do
    ...
    python3 submodules/laptq_utils/main.py \
        ...
        --map__id_class__to__thresh_conf "{0:0.2,1:0.5,2:0.5}"
