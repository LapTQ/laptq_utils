...
declare -A MAP__SUBPATH_DIR__TO__POSTFIX_DIR_VERSION=(
    ...
    # ["APTO_v2/day1_330"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["APTO_v2/night1_190"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["APTO_v2/night3_44"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["APTO_v2/night4_239"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["Pothole_235/train"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["dataset-ninja/ds1_simplex-test"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["dataset-ninja/ds1_simplex-train"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["dataset-ninja/ds2_complex-test"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["dataset-ninja/ds2_complex-train"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["pot_det_1240"]="--20241129--phase-2--annotated-ver2--only-pot"
    # # ["pothole_dataset_v8/only_rainy_frames/train"]=""
    # ["pothole_dataset_v8/train"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["pothole_dataset_v8/train_to_valid"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["pothole_dataset_v8/valid"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["Pothole_detection_yolo/train_original"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["Pothole_Maeda/first_shot"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["Pothole_Maeda/first_shot_eval"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["Pothole_Maeda/second_shot"]="--20241129--phase-2--annotated-ver2--only-pot"
    # ["RDD2022_JAPAN/only_pothole/train"]="--20241129--phase-2--annotated-ver2--only-pot"
