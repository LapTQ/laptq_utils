...
if __name__ == "__main__":
    ...
    for subpathf, params in {
        ...
        kwargs = {
            # ======= fs26 ========
            "pathd_lbl": "/home/laptq/laptq-fs26-shoplifting-detection/outputs/predict_general/ProtoGCN/fs26/v102--mnit_poselift_roboflow_satudora_awlrecord--r1.9-0xauto-1x1--only-normal-satudora--1s-15frames/{}/labels".format(
                subpathf
            ),
            "pathd_output": "/home/laptq/laptq-fs26-shoplifting-detection/outputs/major_vote_action/ProtoGCN/fs26/v102--mnit_poselift_roboflow_satudora_awlrecord--r1.9-0xauto-1x1--only-normal-satudora--1s-15frames--left-window-5--right-window-5/{}/labels".format(
                subpathf
            ),
